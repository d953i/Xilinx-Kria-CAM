...
set_property -dict {PACKAGE_PIN J11 IOSTANDARD LVCMOS33} [get_ports "IAS0_RST[0]"]
set_property -dict {PACKAGE_PIN J10 IOSTANDARD LVCMOS33} [get_ports "IAS0_STDBY[0]"]
